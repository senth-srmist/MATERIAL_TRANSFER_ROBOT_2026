...
// PATCHED VERSION (v2) — added _camlink2base for camera→base_link transform
...
private:
  ...
  tf2::Transform _left2base;    // zed_left_camera_frame → zed_camera_link
  tf2::Transform _camlink2base; // zed_camera_link → base_link [NEW]
