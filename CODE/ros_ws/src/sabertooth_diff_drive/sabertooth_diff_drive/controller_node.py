...
# ================= VELOCITY LIMITS (FROM NAV2 PARAMS) =================
MIN_LINEAR_VEL  = -0.2     # m/s
MAX_LINEAR_VEL  =  0.78    # m/s
MIN_ANGULAR_VEL = -3.9     # rad/s
MAX_ANGULAR_VEL =  3.9     # rad/s

# ================= DYNAMICS LIMITS =================
MAX_LINEAR_ACCEL  = 0.3    # m/s^2
MAX_LINEAR_DECEL  = 0.6    # m/s^2
MAX_ANGULAR_ACCEL = 1.5    # rad/s^2

# ================= CONTROL =================
CONTROL_DT = 0.05          # 20 Hz controller

# ================= MOTOR SCALING =================
# Tune this experimentally (wheel max rad/s)
