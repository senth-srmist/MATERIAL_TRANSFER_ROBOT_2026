...
> **Note:** Skip step 2 and 3 if your device doesn't have NVIDIA graphics. Any ZED Camera related packages will not work in this case. Use colcon build --packages-select to build packages that do not involve the ZED Camera.
